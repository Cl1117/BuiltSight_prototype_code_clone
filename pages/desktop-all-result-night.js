...
import styles from "./desktop-all-result-night.module.css";
const DesktopAllResultNight = () => {
  const [
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDateFns}>
      <div className={styles.desktopallResultNight}>
...
export default DesktopAllResultNight;
